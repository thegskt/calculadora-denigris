...
// VARIANTES (adicione todas as linhas conforme sua lista)
  ...
  try{
    ...
    if (reloaded) {
      location.replace('login.html?next=' + encodeURIComponent('index.html' + location.search));
    }
  }catch(e){}
})();
  ...
  document.getElementById("anoModeloFab").addEventListener("change", atualizarVarianteFab);
    ...
    async function carregarDados() {
      try {
        ...
        applyQueryParams(); // garante preenchimento com o mapa carregado
      } catch (err) {
...
// Parser robusto: extrai linhas 'CHAVE' : ['A','B',...]
  ...
  } catch(e) { console.warn('applyQueryParams error', e); }
  }
